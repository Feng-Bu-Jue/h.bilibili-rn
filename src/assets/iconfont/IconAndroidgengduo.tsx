...
const IconAndroidgengduo: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconAndroidgengduo.defaultProps = {
  size: 18,
};

export default React.memo ? React.memo(IconAndroidgengduo) : IconAndroidgengduo;
